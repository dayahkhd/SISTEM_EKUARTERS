...
printf("<script> alert ('Maklumat telah dikemaskini.'); window.location = 'paparkendiri.php?id=$kendiriid&randomno=$randomno'</script>");
...
<table width="100%" border="1" cellpadding="1" align="center" bgcolor="#E1E1FF" bordercolor="#CCCCCC" cellspacing="1">
  <tbody>
    ...
    <tr bgcolor="#CED8FF">
      ...
      <textarea name="fsoketc" cols="70" rows="2" id="fsoketc"><?php echo $kfsoketc; ?></textarea>
      <br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfsoketc; ?>
  </div></td>
    </tr>
    <tr>
      <td height="26">2</td>
      ...
      <textarea name="fkipasc" cols="70" rows="2" id="fkipasc"><?php echo $kfkipasc; ?></textarea>
 <br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfkipasc; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">3</td>
      <td>Lampu</td>
      ...
      <textarea name="flampuc" cols="70" rows="2" id="flampuc"><?php echo $kflampuc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkflampuc; ?></div></td>
    </tr>
    <tr>
      <td height="26">4</td>
      <td>Pendawaian</td>
      ...
      <textarea name="fdawaic" cols="70" rows="2" id="fdawaic"><?php echo $kfdawaic; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfdawaic; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="39">5</td>
    ...
    <tr>
      ...
      <td>
        ...
        <textarea name="ftekananairc" cols="70" rows="2" id="ftekananairc"><?php echo $kftekananairc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkftekananairc; ?></div>
      </td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">7</td>
      ...
      <textarea name="fhawadinginc" cols="70" rows="2" id="fhawadinginc"><?php echo $kfhawadinginc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfhawadinginc; ?></div></td>
    </tr>
    <tr>
      <td height="26">8</td>
      ...
      <textarea name="ftangkiseptikc" cols="70" id="ftangkiseptikc"><?php echo $kftangkiseptikc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkftangkiseptikc; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">9</td>
      ...
      <textarea name="fpambocorc" cols="70" id="fpambocorc"><?php echo $kfpambocorc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfpambocorc; ?></div></td>
    </tr>
    <tr>
      <td height="26">10</td>
      ...
      <textarea name="fsinkibocorc" cols="70" id="fsinkibocorc"><?php echo $kfsinkibocorc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfsinkibocorc; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">11</td>
      ...
      <textarea name="fpaippecahc" cols="70" id="fpaippecahc"><?php echo $kfpaippecahc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfpaippecahc; ?></div></td>
    </tr>
    <tr>
      <td height="39">12</td>
      <td>Lain-Lain</td>
    ...
    <tr bgcolor="#CED8FF">
      ...
      <td>
        ...
        <textarea name="fretakc" cols="70" id="fretakc"><?php echo $kfretakc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfretakc; ?></div>
      </td>
    </tr>
    <tr>
      <td >14</td>
      ...
      <textarea name="fpatahc" cols="70" id="fpatahc"><?php echo $kfpatahc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfpatahc; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td >15</td>
      ...
      <textarea name="fcabutc" cols="70" id="fcabutc"><?php echo $kfcabutc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfcabutc; ?></div></td>
    </tr>
    <tr>
      <td >16</td>
      <td>Bocor</td>
      ...
      <textarea name="fbocorc" cols="70" id="fbocorc"><?php echo $kfbocorc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfbocorc; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td >17</td>
      <td>Karat</td>
      ...
      <textarea name="fkaratc" cols="70" id="fkaratc"><?php echo $kfkaratc; ?></textarea>
  <br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfkaratc; ?></div></td>
    </tr>
    <tr>
      <td height="26">18</td>
      <td>Reput</td>
      ...
      <textarea name="freputc" cols="70" id="freputc"><?php echo $kfreputc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfreputc; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td>19</td>
      <td>Anai-anai</td>
      ...
      <td>
        ...
        <textarea name="fanaic" cols="70" id="fanaic"><?php echo $kfanaic; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfanaic; ?></div>
      </td>
    </tr>
    <tr>
      <td height="26">20</td>
      ...
      <td>
        ...
        <textarea name="fkelawarc" cols="70" id="fkelawarc"><?php echo $kfkelawarc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfkelawarc; ?></div>
      </td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">21</td>
      ...
      <textarea name="ftutupc" cols="70" id="ftutupc"><?php echo $kftutupc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkftutupc; ?></div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <textarea name="ftanahruntuhc" cols="70" rows="0" id="ftanahruntuhc"><?php echo $kftanahruntuhc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkftanahruntuhc; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="39">23</td>
      ...
      <td>
        ...
        <textarea name="fteduhanc" cols="70" id="fteduhanc"><?php echo $kfteduhanc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfteduhanc; ?></div></td>
    </tr>
    <tr>
      <td height="26">24</td>
      ...
      <textarea name="ftembokc" cols="70" id="ftembokc"><?php echo $kftembokc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkftembokc; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">25</td>
      ...
      <textarea name="ftamanc" cols="70" id="ftamanc"><?php echo $kftamanc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkftamanc; ?></div></td>
    </tr>
    <tr>
      <td height="26">26</td>
      <td>Pagar Rosak</td>
      ...
      <textarea name="fpagarc" cols="70" id="fpagarc"><?php echo $kfpagarc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfpagarc; ?></div></td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">27</td>
      ...
      <textarea name="flongkangc" cols="70" id="flongkangc"><?php echo $kflongkangc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkflongkangc; ?></div></td>
    </tr>
    <tr>
      <td height="26">28</td>
      ...
      <td>
        ...
        <textarea name="fparkirc" cols="70" id="fparkirc"><?php echo $kfparkirc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfparkirc; ?></div>
      </td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">29</td>
      ...
      <td>
        ...
        <textarea name="flampukawasanc" cols="70" id="flampukawasanc"><?php echo $kflampukawasanc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkflampukawasanc; ?></div>
      </td>
    </tr>
    <tr>
      <td height="26">30</td>
      ...
      <td>
        ...
        <textarea name="flamputanggac" cols="70" id="flamputanggac"><?php echo $kflamputanggac; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkflamputanggac; ?></div>
     </td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">31</td>
      ...
      <td>
       ...
       <textarea name="ftanggapecahc" cols="70" id="ftanggapecahc"><?php echo $kftanggapecahc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkftanggapecahc; ?></div>
      </td>
    </tr>
    <tr>
      <td height="26">32</td>
      ...
      <textarea name="flifrosakc" cols="70" id="flifrosakc"><?php echo $kflifrosakc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkflifrosakc; ?></div></td>
    </tr>
    <tr>
    ...
    <tr bgcolor="#CED8FF">
      ...
      <td>
          ...
          <textarea name="fhangitc" cols="70" id="fhangitc"><?php echo $kfhangitc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfhangitc; ?></div>
</td>
    </tr>
    <tr>
      <td height="26">34</td>
      ...
      <td>
        ...
        <textarea name="fkesanbakarc" cols="70" id="fkesanbakarc"><?php echo $kfkesanbakarc; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfkesanbakarc; ?></div>
</td>
    </tr>
    <tr bgcolor="#CED8FF">
      <td height="26">35</td>
      ...
      <textarea name="fpercikanapic" cols="70" id="fpercikanapic"><?php echo $kfpercikanapic; ?></textarea><br /><br />
      Anggaran Kerosakan (RM) : <?php echo $hkfpercikanapic; ?></div></td>
    </tr>
    <tr>
