            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Senarai Permohonan yang Terima Tawaran Kuarters
                    </div>
                    <div class="panel-body">
                        <table width="1000" border="0" align="center">
                            ...
                            <?php 
                              ...
                              $querymohon     = "SELECT * FROM  tbl_pemohonan  where p_statmohon = 2 AND p_statterima = 1 AND p_stathantar = 1 " ;
                      ...
                      else
                      {
                          ...
                          while($datamohon = mysql_fetch_array($resultmohon))
                          {
                              ...
                              $xidstaff       = $datamohon ['p_staff'];
                                ...
                                $xstatus        = $datamohon ['p_statterima']; 
                        ...
                        //call for TABLE TERIMA
                        $querymohon2     = "SELECT * FROM  tbl_terima WHERE idterima = '$xstatus'";
                        $resultmohon2    = mysql_query($querymohon2) or die(mysql_error());
                        $datastatus2     = mysql_fetch_array($resultmohon2);

                        $ystatus2         = $datastatus2 ['namaterima'];
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td align='center'>&nbsp;&nbsp;<a href="kemaskinipenghuni4.php?id=<?php echo htmlentities($xid);?>">
