...
<html>
<head>
    <title>Senarai Lokasi Kuarters Berdaftar</title>
...
<body>
                                ...
                                <div class="dataTable_wrapper">
                                    ...
                                    <?php 
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                $xid = $datadaftar2['l_id'];
                                                $xalamat = $datadaftar2['l_nama'];
                                                $xkodjabatan = $datadaftar2['l_jabatan'];
                                            ...
                                            ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td align='center'>&nbsp;&nbsp;<a href="updatelokasi.php?id=<?php echo $xid;?>">
                                                        <p class="fa fa-edit"></p></a>
                                                          
                                                    </td>     

                                                    <td align='center'>&nbsp;&nbsp;<a href="padamlokasi.php?id=<?php echo htmlentities($xid);?>">
    ...
    <?php
        ...
        if(isset($_GET["delete"])){
            ...
            $query = "DELETE FROM tbllokasi WHERE l_id = '$delete'";
            mysql_query($query);

            printf("<script>alert('MAKLUMAT TELAH DIHAPUSKAN'); window.location='listlokasi.php'</script>");
        }
