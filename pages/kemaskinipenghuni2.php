...
$fid = $_GET['id'];
	...
	$lamamohon			= $datalast['p_markahlamamohon'];
	$days 		= $datalast['p_lamamohon'];
...
$diff2 = abs(strtotime($today) - strtotime($dtmohon));
$years = floor($diff2 / (365*60*60*24));
$days = floor(($diff2 - $years * 365*60*60*24) / (30*60*60*24)); // need to declare as $days later
// $days = floor(($diff2 - $years * 365*60*60*24 - $months*30*60*60*24)/ (60*60*24)); // this is for testing
	...
	$fmarks = $lamamohon+$markah;


	$queryUpd     	= "UPDATE tbl_pemohonan SET
	p_lamamohon	  		=	'".mysql_real_escape_string($days)."',
	p_markahlamamohon 	=	'".mysql_real_escape_string($lamamohon)."',
	p_finalmarks 	=	'".mysql_real_escape_string($fmarks)."'
...
?>
			...
			<div class="form-group">
		    <div class="col-lg-5">
			<label>Tempoh Permohonan (bulan):</label></div>
			<div class="col-lg-6">
			  <!-- <label for="ftmohon">:</label> -->
              <input type="text" name="ftmohon" id="ftmohon" class=form-control value="<?php echo $days; ?>"> 

              <?php

              //echo $lamamohon;
              ?>
              	<!-- <p><font color="#FF0000"><b>*Sila tekan butang MARKAH untuk pengiraan keseluruhan pemarkahan </b></font><p>
              	
              	<div class="panel-body">
     			<input type="submit" class="btn btn" name="markah1" id="markah1" value="MARKAH">
    			</div> -->
			</div> 								
			</div>						 
			<br><br>					
			...
			<div class="col-lg-6">
              ...
              <div name="flokasimohon" id="flokasimohon">
				...
				<?php
                    ...
                    {
                        echo "<option value = $lokasiquery[l_id]>$lokasiquery[l_jabatan]-$lokasiquery[l_nama]</option>";
                    } 
                     echo "</select>";
     // //                echo $lokasi_2;
			...
			<div class="panel panel-primary">
				<div class="panel-heading" align="center"><b>UNTUK KEGUNAAN PEJABAT</b></div>
			        <!--  <form name="form1" method="post" action=""> -->
			 		...
			 		<div class="form-group">
			 			<div class="form-group">
					 <div class="col-lg-4"><font color="#FF0000"><b>Markah :</b></font></div>
					 <div class="col-lg-6">
					 <!-- <label for="fkelasrumah">:</label> -->
					
				     <input name="fkelasrumah" type="text" id="fkelasrumah" size="50" class=form-control value=" <?php echo $markah ?>">
				     <!-- <p><font color="#FF0000"><b>*Sila tekan butang MARKAH untuk pengiraan keseluruhan pemarkahan </b></font><p> -->
              	<!-- <input type="hidden" name="fid" value="<?php //echo $fid?>">  -->
		              	<!-- <div class="panel-body">
		     			<input type="submit" class="btn btn-danger" name="markah1" id="markah1" value="MARKAH">
		    			</div> -->
					 </div>
						<br>
					</div>
					<div class="form-group">
					 <div class="col-lg-4"><font color="#FF0000"><b>Markah Keseluruhan (termasuk tempoh lama mohon) :</b></font></div> <!-- need to call tbl_kelas for s_nama -->
					 <div class="col-lg-6">
					 <!-- <label for="fkelasrumah">:</label> -->
					
				     <input name="fkelasrumah" type="text" id="fkelasrumah" size="50" class=form-control value=" <?php echo $fmarks ?>">
				    ...
				    <!-- <label for="lulus"></label> -->
				     ...
				     <?php
			        		...
			        		$query_falamattawaran = "select * from tblalamat WHERE a_buka = 2"; //WHERE  && dtbertugas  AND a_jabatan = '$dlokasimohon'
...
<?php
	...
	if(isset($_POST['markah1']) == "MARKAH"){

// $fid = $_POST['fid']; // need to add hidden text for fid in form

// $querycalc = "SELECT SUM(p_markahlamamohon+p_totalmarkah) AS Total FROM tbl_pemohonan WHERE p_id = '$fid'";

// $resultcalc =  mysql_query($querycalc); // or die(mysql_error())

// $datacalc = mysql_fetch_array($resultcalc);

// $querysum = $datacalc['Total'];

// echo ("Total marks gained: $querysum"); // suggested from kak fika
	}
...
<?php
		...
		printf("<script> alert('DATA TELAH DIKEMASKINI.'); window.location = 'kemaskinipenghuni2.php?id=$fid' </script>");
