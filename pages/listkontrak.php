                                    ...
                                    <?php 
                                        ...
                                        else
                                        {
                                            ...
                                            while($datamohon2 = mysql_fetch_array($resultmohon))
                                            {
                                                ...
                                                $querystatus   = "SELECT * FROM  tbl_statkontrak WHERE idkontrak = '$xkontrak'";
                                                $resultstatus  = mysql_query($querystatus) or die(mysql_error());
                                                $datastatus    = mysql_fetch_array ($resultstatus);

                                                $ykontrak        = $datastatus['namakontrak'];
                                            ...
                                            ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><?php echo htmlentities(strtoupper($rnama));?></td>
                                                    ...
                                                    <td><?php echo htmlentities(strtoupper($yhantar ));?></td>  
                                                     <td><?php echo htmlentities(strtoupper($ykontrak ));?></td>  
