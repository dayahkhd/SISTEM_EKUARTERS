...
$file="borangkendiri$kendiriid.xls";
...
'".mysql_real_escape_string($fperiksa2)."',
...
'".mysql_real_escape_string($fkesanbakar)."',
'".mysql_real_escape_string($fkesanbakarc)."',
...
<table width="100%" height="437" border="1" cellpadding="1" align="center" bgcolor="#E1E1FF" bordercolor="#CCCCCC" cellspacing="1">
  ...
  <tr bgcolor="#CED8FF">
    ...
    <tr>
      ...
      <td width="4">:</td>
      <td><input name="fnomykad" type="text" id="fnomykad" value="<?php echo $kfnomykad; ?>" size="20" readonly="readonly"></td>
    ...
    <tr bgcolor="#CED8FF">
      ...
      <td>:</td>
      <td colspan="2">
        <input type="text" name="fbangunan" id="fbangunan" size="70" value="<?php echo $kfbangunan; ?>"></td>
    </tr>
    <tr>
...
<select name="fperiksa" required="required" id="fperiksa">
      ...
      <td><div id="divperiksa">Nyatakan bila dan kenapa<br />
        <textarea name="fperiksa2" cols="70" rows="2" id="fperiksa2" type="text"><?php echo $kfperiksa2; ?></textarea>
      </div></td>
    </tr>
    <tr bgcolor="#CED8FF">
...
<table width="100%" border="1" cellpadding="1" align="center" bgcolor="#E1E1FF" bordercolor="#CCCCCC" cellspacing="1">
  <tbody>
    ...
    <tr bgcolor="#CED8FF">
      ...
      <td width="656"><div id="divfsoketc">Nyatakan bila dan kenapa<br />
    ...
    <tr bgcolor="#CED8FF">
      ...
      <td><div id="divflampuc" >Nyatakan bila dan kenapa<br />
    ...
    <tr bgcolor="#CED8FF">
      ...
      <td><div id="divfhawadinginc" >Nyatakan bila dan kenapa<br />
    ...
    <tr bgcolor="#CED8FF">
      ...
      <td><div id="divfpambocorc" >Nyatakan bila dan kenapa<br />
    ...
    <tr bgcolor="#CED8FF">
      ...
      <td><div id="divfpaippecahc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td><div id="divfpatahc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td><div id="divfbocorc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td><div id="divfreputc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td>
        <div id="divfkelawarc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td>
        <div id="divftanahruntuhc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td><div id="divftembokc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td><div id="divfpagarc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td>
        <div id="divfparkirc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td>
        <div id="divflamputanggac" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td><div id="divflifrosakc" >Nyatakan bila dan kenapa<br />
    ...
    <tr>
      ...
      <td>
        <div id="divfkesanbakarc" >Nyatakan bila dan kenapa<br />
