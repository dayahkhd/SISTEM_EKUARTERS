...
<title>Daftar Kuarter- Admin</title>
...
if(isset($_POST['daftar']) == "Daftar")
{
	...
	$querylast = "INSERT into tbl_daftarkuarter(k_idasset,k_alamatrumah,k_kelas,k_lokasi,k_jenisasset,k_jenisrumah) 
...
printf("<script> alert('Maklumat telah berjaya disimpan.'); window.location='testing2.php?k_idasset=$fdaftarasset'</script>");
...
<form method="post" >
	<div id="wrapper">
	<!-- <?php
	// $querynama     = "SELECT * FROM  tablepengguna WHERE nokadpengenalan = '" .$_SESSION['user']."'";
...
<div class="col-lg-12">
					<h4 class="page-header"><!--  SELAMAT DATANG <?php   $rnama;?> --><?php echo strtoupper("selamat datang"." ".htmlentities($_SESSION['namapegawai']));?></h4>
										...
										<div class="form-group">
											...
											<!-- <div class="col-lg-6">
			 								...
			 								<div class="col-lg-6">
												...
												echo "<select class=form-control name=alamatrumah id=alamatrumah required=required>";
