...
?>
	 ...
	 <br><br>
		...
		<div class="row">
			<div class="col-lg-12">
			<div class="panel panel-primary">
			<div class="panel-heading" align="center"><b>D) MAKLUMAT KELUARGA PEMOHON</b>ß</div>
			<div class="panel-body">
			<div class="row">
			  <div class="col-lg-12">
			    <div class="form-group">
			...
			<div class="panel panel-primary">
				<div class="panel-heading" align="center"><b>UNTUK KEGUNAAN PEJABAT</b></div>
					...
					<div class="col-lg-6">
				 	...
				 	<div name="keputusanmohon" id="keputusanmohon">
			        	<?php
...
<!-- 	 <div class="row">
			...
			<div class="panel panel-default">
				<div class="panel-heading">KEPUTUSAN BAHAGIAN PEJABAT </div>
				<div class="panel-body">
					 <div class="row">
			<div class="col-lg-12">
			<div class="panel panel-default">
