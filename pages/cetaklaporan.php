...
<title>SENARAI PEMERIKSAAN KENDIRI KESELAMATAN KUARTERS</title>
<style type="text/css">
#headd {
	font-size: 24px;
}
...
<center>
  <p id="headd"><strong>SENARAI PEMERIKSAAN KENDIRI KESELAMATAN KUARTERS</strong></p>
  <table width="1249" border="0" cellspacing="0" cellpadding="1" align="center">
  <tr>
    <td width="139" bgcolor="#C2EBBE">Tarikh Mula</td>
    <td width="201" bgcolor="#C2EBBE">:
      <input name="tarikhmula" id="tarikhmula" type="date" required="required" /></td>
    <td width="101" bgcolor="#C2EBBE">Tarikh Akhir</td>
    <td width="223" bgcolor="#C2EBBE">:
      <input name="tarikhakhir" id="tarikhakhir" type="date" required="required" /></td>
    <td width="128" bgcolor="#C2EBBE">Lokasi</td>
    <td width="204" bgcolor="#C2EBBE">:
      <?php
            ...
            echo "</select>";
        ?></td>
    <td width="72" bgcolor="#C2EBBE"><input type="submit"  name="CARI" value="CARI" id="CARI" /></td>
    <td width="92" bgcolor="#C2EBBE" align="left">
      <input type="submit"  name="MUATTURUN" value="MUATTURUN" id="MUATTURUN" />
    </a></td>
    </tr>
</table></center>
<p>&nbsp;</p>
...
<tr>
<th  rowspan="3" bgcolor="#CCCCCC">Bil</th>
<th  rowspan="3" bgcolor="#CCCCCC">Tarikh</th>
<th  rowspan="3" bgcolor="#CCCCCC">Nama</th>
<th  rowspan="3" bgcolor="#CCCCCC">No MyKad</th>
<th  rowspan="3" bgcolor="#CCCCCC">No Telefon</th>
<th  rowspan="3" bgcolor="#CCCCCC">Lokasi</th>
<th  rowspan="3" bgcolor="#CCCCCC">Alamat</th>
<th  rowspan="3" bgcolor="#CCCCCC">No Bangunan</th>
<th  rowspan="3" bgcolor="#CCCCCC">Jenis Binaan</th>
<th  rowspan="3" bgcolor="#CCCCCC">Jenis Rumah</th>
<th  rowspan="3" bgcolor="#CCCCCC">Jumlah Bilik</th>
<th  rowspan="3" bgcolor="#CCCCCC">Latihan Pencegahan Kebakaran</th>
<th  colspan="2" bgcolor="#CCCCCC">Pemeriksaan Keselamatan</th>
<th  rowspan="3" bgcolor="#CCCCCC">Fire Blanket</th>
<th  rowspan="3" bgcolor="#CCCCCC">Fire Extinguisher </th>
<th colspan="9" bgcolor="#CCCCCC">Elektrikal</th>
<th colspan="13" bgcolor="#CCCCCC">Mekanikal</th>
<th colspan="18" bgcolor="#CCCCCC">Sivil , Struktur & Seni Bina</th>
<th colspan="22" bgcolor="#CCCCCC">LUAR RUMAH & KAWASAN GUNA SAMA</th>
<th colspan="6" bgcolor="#CCCCCC">KESELAMATAN KEBAKARAN</th>
<th  colspan="1" rowspan="3" bgcolor="#CCCCCC">LAIN-LAIN</th>
<th colspan="27" bgcolor="#CCCCCC">SENARAI KUNCI</th>
<th colspan="6" bgcolor="#CCCCCC">METER</th>


<th colspan="18" bgcolor="#CCCCCC">MASTER BEDROOM</th>
<th colspan="18" bgcolor="#CCCCCC">BATHROOM 2</th>
<th colspan="18" bgcolor="#CCCCCC">BATHROOM 3</th>

<th colspan="3" bgcolor="#CCCCCC">KITCHEN</th>

<th colspan="3" bgcolor="#CCCCCC">CAR PORCH</th>

<th colspan="3" bgcolor="#CCCCCC">YARD</th>

<th colspan="24" bgcolor="#CCCCCC">ELECTRICAL SCHEDULE</th>

</tr>
<tr>
  <th  rowspan="2" bgcolor="#CCCCCC">Status</th>
  <th  rowspan="2" bgcolor="#CCCCCC">Catatan</th>
  <th colspan="2" bgcolor="#CCCCCC">Soket / suis</th>
  <th colspan="2" bgcolor="#CCCCCC">Kipas</th>
  <th colspan="2" bgcolor="#CCCCCC">Lampu</th>
  <th colspan="2" bgcolor="#CCCCCC">Pendawaian</th>
  <th  rowspan="2" bgcolor="#CCCCCC">Lain-lain</th>
  
  <th colspan="2" bgcolor="#CCCCCC">Tekanan air rendah/tiada air</th>
  <th colspan="2" bgcolor="#CCCCCC">Alat pendingin hawa</th>
  <th colspan="2" bgcolor="#CCCCCC">Tangki septik tersumbat</th>
  <th colspan="2" bgcolor="#CCCCCC">Pam tandas rosak/bocor</th>
  <th colspan="2" bgcolor="#CCCCCC">Sinki bocor/tersumbat</th>
  <th colspan="2" bgcolor="#CCCCCC">Paip pecah/bocor</th>
  <th  rowspan="2" bgcolor="#CCCCCC">Lain-lain</th>
  
  <th colspan="2" bgcolor="#CCCCCC">Retak</th>
  <th colspan="2" bgcolor="#CCCCCC">Patah</th>
  <th colspan="2" bgcolor="#CCCCCC">Tercabut/ Tertanggal</th>
  <th colspan="2" bgcolor="#CCCCCC">Bocor</th>
  <th colspan="2" bgcolor="#CCCCCC">Karat</th>
  <th colspan="2" bgcolor="#CCCCCC">Reput</th>
  <th colspan="2" bgcolor="#CCCCCC">Anai-anai</th>
  <th colspan="2" bgcolor="#CCCCCC">Kelawar</th>
  <th colspan="2" bgcolor="#CCCCCC">Tidak boleh ditutup / dikunci (Pintu/Tingkap)</th>  
  
  <th colspan="2" bgcolor="#CCCCCC">Tanah Runtuh</th>
  <th colspan="2" bgcolor="#CCCCCC">Pokok teduhan reput/mati/berisiko untuk tumbang</th>
  <th colspan="2" bgcolor="#CCCCCC">Tembok penahan retak/pecah</th>
  <th colspan="2" bgcolor="#CCCCCC">Taman permainan/rekreasi rosak/tidak selamat</th>
  <th colspan="2" bgcolor="#CCCCCC">Pagar Rosak</th>
  <th colspan="2" bgcolor="#CCCCCC">Longkang pecah/banjir/tersumbat/air bertakung</th>
  <th colspan="2" bgcolor="#CCCCCC">Parkir pecah/ berlubang</th>
  <th colspan="2" bgcolor="#CCCCCC">Lampu kawasan/parkir rosak</th>
  <th colspan="2" bgcolor="#CCCCCC">Lampu tangga rosak</th>  
  <th colspan="2" bgcolor="#CCCCCC">Tangga pecah/tidak selamat</th>
  <th colspan="2" bgcolor="#CCCCCC">Lif rosak</th>  

  <th colspan="2" bgcolor="#CCCCCC">Berbau hangit</th>  
  <th colspan="2" bgcolor="#CCCCCC">Kesan terbakar</th>
  <th colspan="2" bgcolor="#CCCCCC">Percikan api</th>  
  
  <th colspan="3" bgcolor="#CCCCCC">Pintu Utama</th>
  <th colspan="3" bgcolor="#CCCCCC">Bilik Tidur Utama</th>
  <th colspan="3" bgcolor="#CCCCCC">Bilik Tidur 2</th>
  <th colspan="3" bgcolor="#CCCCCC">Bilik Tidur 3</th>
  <th colspan="3" bgcolor="#CCCCCC">Bilik Tidur 4</th>
  <th colspan="3" bgcolor="#CCCCCC">Stor</th>
  <th colspan="3" bgcolor="#CCCCCC">Yard / Dapur</th>
  <th colspan="3" bgcolor="#CCCCCC">Ruang Makan / Ruang Tamu</th>
  <th colspan="3" bgcolor="#CCCCCC">Pantri</th>
  
  <th colspan="3" bgcolor="#CCCCCC">Meter Elektrik TNB</th>
  <th colspan="3" bgcolor="#CCCCCC">Meter Air SAJR</th>  
  
  <th colspan="3" bgcolor="#CCCCCC">Pedestal WC</th>
  <th colspan="3" bgcolor="#CCCCCC">Shower rose</th>
  <th colspan="3" bgcolor="#CCCCCC">Wash basin</th>
  <th colspan="3" bgcolor="#CCCCCC">Toilet paper holder</th>
  <th colspan="3" bgcolor="#CCCCCC">Soap disk/ ledge</th>
  <th colspan="3" bgcolor="#CCCCCC">Bib tap</th>
  ...
  <th colspan="3" bgcolor="#CCCCCC">Kitchen Sink</th>
  
  <th colspan="3" bgcolor="#CCCCCC">Bib Tap</th>
    
  <th colspan="3" bgcolor="#CCCCCC">Bib Tap</th>

  <th colspan="3" bgcolor="#CCCCCC">Lighting Point</th>
  <th colspan="3" bgcolor="#CCCCCC">Fan Point</th>
  <th colspan="3" bgcolor="#CCCCCC">Power point (13A)</th>
  <th colspan="3" bgcolor="#CCCCCC">Telephone point</th>
  <th colspan="3" bgcolor="#CCCCCC">TV point</th>
  <th colspan="3" bgcolor="#CCCCCC">Heater point</th>
  <th colspan="3" bgcolor="#CCCCCC">Air-cond point</th>
  <th colspan="3" bgcolor="#CCCCCC">Gate Bell point</th>

      
  </tr>
<tr>
  <th  bgcolor="#CCCCCC">Keadaan</th>
  <th  bgcolor="#CCCCCC">Catatan</th>
  <th  bgcolor="#CCCCCC">Keadaan</th>
  <th  bgcolor="#CCCCCC">Catatan</th>
  <th  bgcolor="#CCCCCC">Keadaan</th>
  <th  bgcolor="#CCCCCC">Catatan</th>
  ...
  <th  colspan="1" bgcolor="#CCCCCC">No Meter</th>
  <th  bgcolor="#CCCCCC">Bacaan</th>
  <th  bgcolor="#CCCCCC">Catatan</th>
  <th  colspan="1" bgcolor="#CCCCCC">No Meter</th>
  <th  bgcolor="#CCCCCC">Bacaan</th>
  <th  bgcolor="#CCCCCC">Catatan</th>
...
if(isset($_POST['CARI']) == "CARI") 
{

$tarikhmula = $_POST['tarikhmula'];
$tarikhakhir = $_POST['tarikhakhir']; 
$flokasi = $_POST['flokasi']; 

$tarikhmulaa = date('Y-m-d',strtotime($tarikhmula));
$tarikhakhira = date('Y-m-d',strtotime($tarikhakhir));
...
$lokasinama	 	 = $datalokasi['l_nama'];

echo "<b>SENARAI PEMERIKSAAN KENDIRI KESELAMATAN KUARTERS ($ptarikhmula HINGGA $ptarikhakhir) </b>";
echo "<br><b>LOKASI : $lokasinama;</b>";
...
if(isset($_POST['MUATTURUN']) == "MUATTURUN") 
{

$tarikhmula = $_POST['tarikhmula'];
$tarikhakhir = $_POST['tarikhakhir']; 

printf("<script>window.location = 'cetaklaporanexcel.php?tarikhmula=$tarikhmula&tarikhakhir=$tarikhakhir&lokasi=$flokasi' </script>");
