                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div align="center">Senarai Setuju Terima </div>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Status Terima/Tidak Terima</th>
                                    ...
                                    <?php 
                                    //         $queryguna      = "SELECT * FROM tablepengguna WHERE id ='p_staff'";
                                    ...
                                    //         $icpengguna     = $dataguna ['nokadpengenalan'];
                                     ...
                                     $queryguna      = "SELECT * FROM tablepengguna WHERE nokadpengenalan ='$user2'" ;
                                         ...
                                         // TABLE PERMOHON
                                            $querymohon     = "SELECT * FROM  tbl_pemohonan WHERE p_staff ='$idstaff' ";
                                        ...
                                        else
                                        {
                                            ...
                                            while($datamohon2 = mysql_fetch_array($resultmohon))
                                            {
                                                ...
                                                $xstatusterima  =$datamohon2 ['p_statterima'];
                                                $xidstaff       = $datamohon2 ['p_staff'];
                                                // $xgagal        =$datamohon2['p_statmohon'];
                                                ...
                                                $querystatus   = "SELECT * FROM  tbl_terima WHERE idterima = '$xstatusterima'";
                                                $resultstatus  = mysql_query($querystatus) or die(mysql_error());
                                                $datastatus    = mysql_fetch_array ($resultstatus);

                                                $yterima        = $datastatus['namaterima'];

                                                //gagal

                                                // $querystatus   = "SELECT * FROM  tbl_statmohon WHERE m_id= '$xgagal'";
                                                // $resultstatus  = mysql_query($querystatus) or die(mysql_error());
                                                // $datastatus    = mysql_fetch_array ($resultstatus);

                                                // $ygagal        = $datastatus['m_nama'];
                                            ...
                                            ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><?php echo htmlentities(strtoupper($yterima ));?></td>  
                                                    <!--  <td><?php echo htmlentities(strtoupper($ygagal ));?></td> -->
                                                                                      
                                                    <td align='center'>&nbsp;&nbsp;<a href="kemaskinipenghuni.php?id=<?php echo htmlentities($xid);?>">
