...
$xstaff             = $data['p_staff'];
$xkilo				= $data['p_kilometer'];

//checkbox tandatangan
$xtandamohon        = $data['p_tandamohon'];


$query_guna	= "SELECT * FROM tablepengguna WHERE id = '$xstaff'";
...
//table jabatan
$queryjabatan	= "SELECT * FROM tablejabatan WHERE id = '$xtbertugas'";
...
if(isset($_POST['hantar']) == "Hantar")
		...
		printf("<script> alert('DATA TELAH DI HANTAR.'); window.location ='listpemohon.php?id=$xid' </script>");
	...
	// checkbox tandatangan mohon 
		...
		p_kilometer          =  '".mysql_real_escape_string($kilo)."'
		...
		printf("<script> alert('DATA TELAH DIKEMASKINI.'); window.location ='kemaskinipermohonan.php?id=$xid' </script>");
	}
...
?>
			...
			<div class="col-lg-6">
             ...
             <!--  <input type="date" name="tarikhm" id="tarikhm" value=" --> <?php echo (date("d-m-Y", strtotime($xtmohon))); ?> 
			</div>								
			</div>	
			...
			<div class="panel-heading" align="center">A) MAKLUMAT KEDIAMAN PEMOHON</div>
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-lg-8">
			      	...
			      	<?php
									$query_kilo = "select * from tbl_kilometer";
									$result_kilo = mysql_query($query_kilo) or die (mysql_error());
									echo "<select name=kilo id=kilo >";
									echo "<option value=$yidkilo>$ykilometer</option>";
									while($data_kilo = mysql_fetch_array($result_kilo))
									{
										echo "<option value = $data_kilo[idkilo]>$data_kilo[kilometer]</option>";
									}
										echo "</select>";		   
					?>
			      </div>
			      	...
			      	<div class="col-lg-4">Tempat Bertugas</div>
			     			<div class="col-lg-8">
			        			<label name="jabatan" id="jabatan"for="tbertugas">:</label>
									<?php
										$query1 = "select * from tablejabatan";
          		...
          		<div class="row">	
             		<div class="form-group">
			      	...
			      	<div>
				        ...
				        <p>
							<input type="checkbox" name="tandamohon" id="tandamohon" <?php if (isset($xtandamohon) && $xtandamohon == "1") echo "checked"; ?> value="1" required='required'> </input>
			...
			<div class="col-lg-10" align="center">
				<!--<div class="col-lg-6"></div>-->
					...
					{ ?>
						...
						<input type="submit" class="btn btn-primary" name="submit"  value="Kemaskini">
					...
					<a href="../TCPDF/PDF/borangpermohonan.php?id=<?php echo $xid; ?>"><input type="" class="btn btn-primary" name="cetak" value="Cetak">
					<?php 
					}
