...
if ($srisiko == '1')
{
	...
	$border = "1";
	$warna = "1";
	$mesej = "ANDA MEMPUNYAI RISIKO DIJANGKITI COVID-19. SILA HUBUNGI NO TELEFON : $nophone  - BILIK GERAKAN CPRC";
	$mesej2 = "(Waktu Operasi Talian : 8.00 Pagi - 8.00 Malam). MOHON TERUS KE KAWASAN SARINGAN COVID-19 YANG DISEDIAKAN";
	$mesej3 = "DI KLINIK KESIHATAN YANG DIPILIH. AMALKAN PENJARAKKAN SOSIAL. KERJASAMA ANDA AMAT KAMI HARGAI";
}
...
elseif ($srisiko == '2')
{
	...
	$border = "1";
	$warna = "1";
	$mesej = "ANDA MEMPUNYAI RISIKO DIJANGKITI COVID-19. MOHON TERUS KE KAWASAN SARINGAN COVID-19 YANG DISEDIAKAN";
	$mesej2 ="DI KLINIK KESIHATAN YANG DIPILIH. AMALKAN PENJARAKKAN SOSIAL. KERJASAMA ANDA AMAT KAMI HARGAI";
	$mesej3 ="";
}
