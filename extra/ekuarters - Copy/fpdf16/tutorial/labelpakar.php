...
$refno = $_GET['refno'];
$q = mysql_query("select * from visitkk where refno = '$refno' and ptj = '$du[phone]'");
$d = mysql_fetch_array($q);

$q2 = mysql_query("select * from patient where id = '$d[patientid]' and ptj = '$du[phone]'");
$d2 = mysql_fetch_array($q2);


$nokp = "$d2[docno]";
$url = $_SERVER[SERVER_ADDR];
$imgurl = "http://$url/eprskk/fpdf16/tutorial/barcode.php?nokp=$nokp"; 

file_put_contents("/var/www/eprskk/fpdf16/tutorial/image/$nokp.gif", file_get_contents("$imgurl"));
...
$q4 = mysql_query("select * from bandar where id = '$d2[bandar]'");
...
$pdf->Image("image/$nokp.gif",54,3,85);
$pdf->Image("image/$nokp.gif",54,67,85);
$pdf->Image("image/$nokp.gif",54,131,85);
...
for($i=1;$i<4;$i++)
{
	...
	$pdf->Cell(43,5,' ');
	$pdf->Cell(50,5,$pakar,0,0,'L');
	$pdf->Cell(50,5,$docs,0,0,'R');
	...
	$xx = "$umur $bday"; 
	$pdf->Cell(70,4,$xx);
	$pdf->Cell(30,4,$d8[nama],0,0,'R');

	$pdf->Ln();
	$pdf->Cell(43,4,' ');
	$pdf->Cell(50,4,$tel);
	$pdf->Cell(50,4,$d9[nama],0,0,'R');

	$pdf->Ln();
	$pdf->Cell(43,4,' ');
	$pdf->Cell(50,4,$waris);
	$pdf->Cell(50,4,$jantina,0,0,'R');
	...
	$pdf->Ln();
	$pdf->Cell(43,4,' ');
	$pdf->Cell(50,4,"T/Daftar : ".$tm);
	$pdf->Cell(50,4,$masa,0,0,'R');

	$pdf->Ln();
	$pdf->Cell(43,4,' ');
	$pdf->Cell(50,4,$d14[nama],0,0,'L');
	$pdf->Cell(50,4,"No Resit : ".$d[noresit],0,0,'R');

	$pdf->Ln();
	$pdf->Cell(43,4,' ');
	$pdf->Cell(50,4,$punca);
	$pdf->Cell(50,4,$bayar,0,0,'R');
