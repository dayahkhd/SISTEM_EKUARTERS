...
$refno = $_GET['refno'];
$q = mysql_query("select * from visitkk where refno = '$refno'");
...
$imgurl = "http://$url/fpdf16/tutorial/barcode.php?text=$nokp"; 
...
$telwaris = "Tel : $d[wenset] $d[wtepon]";
...
$alamatkerja = substr($d2[alamatkerja],0,56);
...
$pdf->AddPage();
	...
	//$pdf->Image("image/$nokp.png",51,54, 800, 9);
	...
	$pdf->Ln();
	//$pdf->Cell(45,4,' ');
	$pdf->Cell(50,4,$waris." ".$telwaris);
	$pdf->Cell(49,4,$d14[nama],0,0,'R');

	$pdf->Ln();
	//$pdf->Cell(45,4,' ');
	$pdf->Cell(50,4,$kerja." ,".$didik);
...
/*
	...
	$xx = "$umur $bday"; 
	$pdf->Cell(70,4,$xx);
	$pdf->Cell(30,4,$jantina,0,0,'R');

	$pdf->Ln();
	$pdf->Cell(45,4,' ');
	$pdf->Cell(50,4,$tel);
	$pdf->Cell(50,4,$d8[nama]."/".$d9[nama],0,0,'R');

	$pdf->Ln();
	$pdf->Cell(45,4,' ');
	$pdf->Cell(50,4,$waris);
	$pdf->Cell(50,4,$d14[nama],0,0,'R');

	$pdf->Ln();
	$pdf->Cell(45,4,' ');
	$pdf->Cell(50,4,$telwaris);
	$pdf->Cell(50,4,"No Resit : ".$d[noresit]."    ".$bayar,0,0,'R');

	$pdf->Ln();
	$pdf->Cell(45,6,' ');
	$pdf->Cell(50,4,"T/Daftar : ".$tm."  ".$masa);
	$pdf->Cell(50,4,$punca,0,0,'R');

	$pdf->Ln();
	$pdf->Cell(50,9,' ');

$pdf->AddPage();
$pdf->Image("image/$nokp.png",51,3, 100, 9);
