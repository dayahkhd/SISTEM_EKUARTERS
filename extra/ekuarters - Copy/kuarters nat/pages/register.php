...
//tbl_kategorijawatan
$querykatjawat	= "SELECT * FROM tbl_katjawatan WHERE t_id = '$katjawatan'";
$resultkatjawat	= mysql_query($querykatjawat) or die(mysql_error());
$_POSTkatjawat	= mysql_fetch_array($resultkatjawat);

$katjawatan     = $_POSTkatjawat['t_kategori'];
...
if (! (isset ( $_SESSION ['nokadpengenalan'] ))) {
	...
	if(isset($_POST['submit']) == "submit"){
	{
		...
		(p_tarikhmohon, p_lokasi, p_ic, p_nama, p_jantina, p_statusperkahwinan, p_telrumah, p_telhp, p_telpejabat, p_jawatan, p_jabatan, p_unit, p_tmulabertugas, p_waktubertugas,  p_namapasangan, p_icpasangan, p_jawatanpasangan, p_tkerjapasangan, p_wbpasangan, p_bilanak, p_alamatsekarang, p_checkbox1, p_checkbox2, p_checkbox3, p_alamatrumahsd, p_jarakrumah, p_sebabmohon, p_pengesahan)
		VALUES
		('$tmohon', '$lokasimohon', '$id', '$nama', '$jantina', '$statusperkahwinan', '$telrumah', '$telhp', '$telpejabat', '$jawatan', '$tbertugas', '$unit', '$tberkhidmat', '$officehour', '$namapasangan', '$nokppasangan', '$jawatanpasangan', '$tbpasangan','$wbpasangan', '$bilanak', '$alamatlama', '$checkbox1', '$checkbox2', '$checkbox3', '$alamatsendiri', '$jarakrumah', '$sebabmohon', '$pengesahan')";
...
<div class="col-lg-12">
 ...
 <div class="panel-body">
 	<div class="form-group">
        ...
        <select name="lulus" id="lulus"></select>
 	</div>
    <label for="lulus"></label>
   
     <div class="form-group">
	 <div class="col-lg-4">Kelas rumah yang layak diduduki</div>
	 <div class="col-lg-6">
	 <label for="layak">:</label>
     <input name="layak" type="text" id="layak" size="50">
	 </div>
	<br>
</div>
     ...
     <input name="pemohon" type="text" id="pemohon" size="50">
	 </div>
	<br>
</div>
    </form>
