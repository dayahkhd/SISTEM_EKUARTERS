...
//table unit
$queryunit		= "SELECT * FROM tableunit WHERE kodunit = '$xunit'";
$resultunit		= mysql_query($queryunit) or die(mysql_error());
$_POSTunit		= mysql_fetch_array($resultunit);

//tbllokasidiphon
$query_lokasi 	= "SELECT * FROM tbl_lokasi WHERE l_id = '$xlokasimohon'";
...
$spdb			= $dsp['p_nama'];//bukan dlm tbl pemohonan
...
$ywbnama        = $datawbetugas['nama'];
...

	{
		...
		p_ic                 =  '".mysql_real_escape_string($id)."',//buang
		p_nama               =  '".mysql_real_escape_string($nama)."',//tukar p_s
		...
		//printf("<script> alert('DATA TELAH DIKEMASKINI.'); window.location ='kemaskini.php?id=$xid' </script>");
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<?php// include('leftbar.php');?>
		...
		<div id="page-wrapper">
					...
					<div class="panel panel-default">
						<div class="panel-heading"></div>
							<div class="panel-body">
								<form action="kemaskini.php?id=<?php echo $xid; ?>" method="post">
								<div class="row">
									<div class="col-lg-10">
										<div class="form-group">
		    								<div class="col-lg-4">
												<label>Tarikh Memohon</label>
											</div>
													<div class="col-lg-6">
			 										 <label for="tarikhm">:</label>
              												<input type="date" name="tarikhm" id="tarikhm" value=<?php echo $xtmohon?>></input>
										</div>								
									</div>
			...
			<div class="form-group">
				<div class="col-lg-4">
					<label>Lokasi Kuarters Yang Dipohon</label>
				</div>
					<div class="col-lg-6">
			    	...
			    	<div class="form-group">
			      		<div class="col-lg-4">Nama</div>
			      			<div class="col-lg-6">
			        			...
			        			<input type="text" name="nama" id="nama" size="70" value="<?php echo $xnama; ?>">
		          			</div>
		        	</div>
 					<br><br>
						...
						<div class="col-lg-4">No K/P</div>
							<div class="col-lg-6">
								<label for="nokp">:</label>
								 <input type="text" name="nokp" id="nokp" value="<?php echo $xid; ?>">
							 </div>
					</div>
					<br><br>
			        	...
			        	<label>Tempat Bertugas</label></div>
			     			<div class="col-lg-6">
			        			<label for="tbertugas">:</label>
									<?php
										$query_tbertugas = "select * from tablejabatan WHERE kodjabatan = '$xtbertugas'";
			      		...
			      		<div class="col-lg-6">
		                    ...
		                    <div name="ohpasangan" id="ohpasagan">
								...
								<?php
									...
									$queryoh2 = "select * from tbl_waktubertugas WHERE id = '$xwbpasangan'";
			...
			<div class="panel-heading">D) MAKLUMAT KEDIAMAN PEMOHON</div>
					...
					<div class="row">
			   		 ...
			   		 <div class="form-group">
			     		 ...
			     		 <div class="col-lg-6">
				        	...
				        	<input type="text" name="alamatlama" id="alamatlama" size="80" rows="3" value="<?php echo $xalamatlama; ?>">
		         		</div>
		        	</div>
			    <br><br>
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-lg-6">
                    ...
                    <input name="alamatrumah" type="text" id="alamatrumah" size="50" value="<?php echo $xalamatsendiri; ?>">
			      </div>
			      <br>
		        </div>
			    <br>
