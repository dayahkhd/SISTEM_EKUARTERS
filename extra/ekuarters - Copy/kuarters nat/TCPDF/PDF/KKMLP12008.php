...
class MYPDF extends TCPDF
{
    ...
    public function SenaraiSemak1() 
	{
		...
		// TAJUK 
			//$this->Ln(3);
			$this->Cell(30);
			$this->Cell(1,1,'SENARAI SEMAK PERMOHONAN LAPORAN PERUBATAN',0,0,'c');
			$this->Ln(10);
			$this->Cell(60);
			$this->Cell(1,1,'A. Permohonan Pesakit (sendiri)',0,0,'R');
		...
		// PERMOHONAN PESAKIT (SENDIRI)
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Permohonan secara bertulis ataupun menggunakan Borang KKMLP/1/2008.',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Surat keizinan ASAL yang ditandatangani oleh pesakit jika melalui pos.',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan Kad Pengenalan pesakit.',0,0,'L');
			
			$this->Ln(5);
			$this->Cell(10);
			$this->Cell(1,1,'d.',0,0,'L');
			$this->Cell(3);
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan Kad Temujanji pesakit.',0,0,'L');
			
			$this->Ln(5);
			$this->Cell(10);
			$this->Cell(1,1,'e.',0,0,'L');
			$this->Cell(3);
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Bayaran (mengikut jenis permohonan).',0,0,'L');
			
			$this->Ln(5);
			$this->Cell(10);
			$this->Cell(1,1,'f.',0,0,'L');
			$this->Cell(3);
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Borang berkaitan (Insurans, KWSP, Buruh 90, PERKESO dan sebagainya).',0,0,'L');
			
			$this->Ln(5);
			$this->Cell(10);
			$this->Cell(1,1,'g.',0,0,'L');
			$this->Cell(3);
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Lain-lain dokumen yang berkaitan dengan rawatan pesakit.).',0,0,'L');
		...
		$this->SetFont('arial', 'B', 10, '', true);
			...
			$this->Ln(10);
			$this->Cell(5);
			$this->MultiCell(170, 4,"B. Permohonan melalui Ibu/ Bapa/ Penjaga yang sah (pesakit berumur 18 tahun Kebawah)", 0, 'L', 0, 0, '', '', true);
			//$this->Cell(1,1,'B. Permohonan melalui Ibu/ Bapa/ Penjaga yang sah (pesakit berumur 18 tahun Kebawah)',0,0,'R');
		...
		// PERMOHONAN IBU BAPA
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Surat keizinan ASAL dari Ibu/Bapa/Penjaga yang sah.',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan Sijil Kelahiran pesakit.',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan Kad Pengenalan Ibu/Bapa/Penjaga yang sah.',0,0,'L');
		...
		$this->SetFont('arial', 'B', 10, '', true);
			...
			$this->Ln(10);
			$this->Cell(5);			
			$this->MultiCell(170, 4,"C. Permohonan Dari Waris (Suami/Isteri/Anak/AdikBeradik/IbuBapa dan waris yang sah) untuk pesakit yang telah meninggal dunia.", 0, 'L', 0, 0, '', '', true);
		...
		// PERMOHONAN WARIS
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Surat keizinan ASAL dari waris (menyatakan maklumat waris).',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan Sijil Kelahiran simati.',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan Kad Pengenalan waris.',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan Kad Temujanji simati.',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan Sijil Nikah (jika berkaitan).',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan Sijil Kelahiran (jika berkaitan).',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Surat Akuan Sumpah (jika berkaitan).',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan permit kubur / Sijil Kematian.',0,0,'L');
			
			$this->Ln(5);
			$this->Cell(10);
			$this->Cell(1,1,'j.',0,0,'L');
			$this->Cell(3);
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Bayaran (mengikut jenis permohonan)',0,0,'L');	
			...
			$this->Ln(10);
			$this->Cell(5);			
			$this->MultiCell(170, 4,"D. Permohonan melalui Pihak ketiga/ Wakil (Insurans, Peguam, Majikan, Jabatan Kerajaan dan lain-lain", 0, 'L', 0, 0, '', '', true);
		...
		// PERMOHONAN WARIS
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Surat keizinan ASAL dari waris (menyatakan memberi kuasa kepada untuk mendapatkan laporan).',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Surat asal izin pesakit (menyatakan nama agen/ wakil / pemohon).',0,0,'L');
			...
			$this->Cell(1,1,'',0,0,'L');
			$this->Cell(2);
			$this->Cell(1,1,'Salinan permit kubur jika pesakit meninggal dunia / mati.',0,0,'L');
	}
