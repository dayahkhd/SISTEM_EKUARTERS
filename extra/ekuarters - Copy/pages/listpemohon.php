                                    ...
                                    //         $icpengguna     = $dataguna ['nokadpengenalan'];
                                        ...
                                        else
                                        {
                                            ...
                                            while($datamohon2 = mysql_fetch_array($resultmohon))
                                            {
                                                ...
                                                $queryguna      = "SELECT * FROM tablepengguna WHERE id ='$xidstaff'";
                                                $resultguna     = mysql_query($queryguna) or die (mysql_error());
                                                $dataguna       = mysql_fetch_array($resultguna);
                                                ...
                                                //TABLE LOKASI
												$querylokasimohon   = "SELECT * FROM  tbl_lokasi WHERE l_id = '$xlokasimohon'";
                                            ...
                                            ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td align='center'>&nbsp;&nbsp;<a href="kemaskinipermohonan.php?id=<?php echo htmlentities($xid);?>">
