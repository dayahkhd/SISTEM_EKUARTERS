...
$status		= 1;
    ...
    $querycheck   	= "SELECT * FROM tablepengguna where nokadpengenalan ='$nomykad' limit 1";
  ...
  <tr bgcolor="#CED8FF">
    ...
    <tr>
      ...
      <td width="516">No Telefon :
        <input name="fnotelefon" type="text" id="fnotelefon" value="<?php echo $fnotel; ?>" size="20" readonly="readonly"></td>
      </tr>
    <tr bgcolor="#CED8FF">
...
<table width="100%" height="1464" border="1" cellpadding="1" align="center" bgcolor="#E1E1FF" bordercolor="#CCCCCC" cellspacing="1">
  ...
  <tr bgcolor="#CED8FF">
    ...
    <td class="tengah"><input name="fsoap" type="text" id="fsoap" size="15" />      <input name="fholder2" type="text" id="fholder2" size="15" /></td>
    <td class="tengah"><?php
