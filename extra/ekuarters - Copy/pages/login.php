                        ...
                        <form method="post">
                            <fieldset>
                                <div class="form-group">
                                	<input name="katamasuk" type="text" size="50" class="form-control" placeholder="Kata Masuk" required/> 
                                </div>                 
                                <div class="form-group">
             						<input name="katalaluan" type="text" size="50" class="form-control" placeholder="Kata Laluan" required/>
             					</div>
