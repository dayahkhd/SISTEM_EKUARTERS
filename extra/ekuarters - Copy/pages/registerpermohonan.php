            ...
            <div class="col-lg-12">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-8">
			        <p>
					<div>
					<input type="checkbox" name="checkketua" id="checkketua" <?php if (isset($checkketua) && $checkketua == "1") echo "checked"; ?> value="1" />
			          <label for="checkketua"><i>Ketua Jabatan/Unit perlu klik untuk setuju</i></label>
			        </p>
					</div>
              </div>
            <br>
