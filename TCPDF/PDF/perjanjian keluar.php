 ...
 //    }
    ...
    public function Body() 
	{
		...
		//LAMPIRAN
			$this->Ln(0);
			$this->Cell(158);
			$this->Cell(1,1,'Lampiran VI',0,0,'L');
			
		// AKUAN MASUK RUMAH
			$this->Ln(10);
			$this->Cell(70);
			$this->Cell('',1,'SIJIL AKUAN KELUAR RUMAH',0,0,'L');
		// KOD
			$this->Ln(7);
			$this->Cell(85);
			$this->Cell(1,1,"(P.A 'E' 30)",0,0,'L');
		...
		//NAMA ANGGOTA
			...
			$this->MultiCell(170, 4,"Dengan ini diakui bahawa rumah di atas beserta dengan semua alat perobot di dalamnya,seperti yang disebutkan dalam Buku Daftar Barang-Barang, dan kawasan rumah telah diambil alih daripada penghuninya seperti nama di bawah. Semuanya didapati dalam keadaan yang baik dan teratur kecuali* perkara-perkara yang disebutkan di bawah:", 0, 'J', 0, 0, '', '', true);
			
		$this->SetFont('arial', '', 11, '', true);
		$this->Ln(30);
		$this->Cell(1);
		$this->Cell(60,1,'Perkara',0,0,'L');
		$this->MultiCell(50, 4, "Corak kehilangan atau kerosakan", 0, 'L', 0, 0, '', '', true);
		$this->SetFont('arial', 'B', 11, '', true);
		$this->Cell(60,1,'Untuk Kegunaan Pejabat',0,0,'L');

		$this->SetFont('arial', '', 11, '', true);
		$this->Ln(6);
		$this->Cell(111);
		$this->MultiCell(60, 4, "Nilai kehilangan atau belanja membaiki atau membaiki atau membaharuinya", 0, 'L', 0, 0, '', '', true);
		...
		//TANDATANGAN PEGAWAI
			$this->Ln(25);
			$this->Cell(1);
			$this->MultiCell(55, 4, "Tandatangan pegawai Perumahan", 0, 'L', 0, 0, '', '', true);
			$this->Cell('',1,'................................................................................................',0,0,'L');	
			$this->Ln(2);
		...
		//TANDATANGAN PP
			$this->Ln(10);
			$this->Cell(1);
			$this->Cell(1,1,'Kehilangan atau kerosakan diakui oleh saya:',0,0,'L');
			$this->Ln(10);
			$this->MultiCell(55, 4, "Tandatangan pegawai Perumahan", 0, 'L', 0, 0, '', '', true);
			$this->Cell('',1,'.................................................................................................',0,0,'L');	
			$this->Ln(2);
...
$this->SetFont('arial', '', 9, '', true);
		//BAWAH LINE
			...
			$this->Cell(52);
			$this->Cell(9);
			$this->Cell(55,1,'* Jika semuanya teratur,tulis "Tiada",di ruangan kehilangan/kerosakan di atas.',0,0,'C');	
			$this->Ln(2);
