...
class MYPDF extends TCPDF
{
	...
	// ** TARIKH TERIMA **
	if (($dtterimaa == '1970-01-01')||($dtterimaa == '0000-00-00')||($dtterimaa == ''))
	{$dtterima 		= '00-00-0000';}
	else
	{$dtterima 		= date('d-m-Y',strtotime($dtterimaa));}
		...
		//AYAT PEMBUKA
			$this->Ln(6);
			$this->Cell(10);
			$this->MultiCell(170, 4,"Dengan segala hormatnya merujuk kepada permohonan tuan/puan 
            bertarikh $dtterima, berhubung dengan pekara di atas.", 0, 'L', 0, 0, '', '', true);
